...
let _ = assert (solve "test/day01.txt" == 11)
let _ = assert (solve "data/day01.txt" == 2769675)
...
let solve2 file =
  ...
  l1
  |> List.map (fun v -> v * try List.assoc v freqs with Not_found -> 0)
  |> List.fold_left ( + ) 0

let _ = assert (solve2 "test/day01.txt" == 31)
let _ = assert (solve2 "data/day01.txt" == 24643097)
